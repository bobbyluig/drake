...
#include "drake/examples/cosserat_rod/helical_buckling/cosserat_rod_plant.h"
...
int do_main(int argc, char* argv[]) {
  ...
  integrator->set_target_accuracy(1.0e-1); //integrator->set_target_accuracy(1.0e-3);
